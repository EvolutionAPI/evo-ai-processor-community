...
class AtlassianService(MCPOAuthService):
    ...
    async def complete_authorization(
        ...
        # If successful, get Atlassian user info
            ...
            try:
                ...
                if access_token:
                    ...
                    async with httpx.AsyncClient() as client:
                        ...
                        result["username"] = user_data.get("name") or user_data.get("account_id")
                ...
                logger.warning(f"Could not fetch Atlassian user info: {e}")
